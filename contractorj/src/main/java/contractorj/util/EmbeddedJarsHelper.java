...
public class EmbeddedJarsHelper {
     ...
     *
     * <p>Note: The jar mut be in the classpath' resource's root with ".jar" replaced in its name by "-jar"</p>
     *
    ...
    public File moveToTemporalFolder(final String originalJarName) {
        ...
        if (url == null) {
            throw new IllegalArgumentException("Couldn't find jar " + originalJarName + " as resource " + resourceName);
        }
