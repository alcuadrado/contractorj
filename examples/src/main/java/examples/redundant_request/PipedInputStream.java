...
public class PipedInputStream extends InputStream {
  ...
  /**
   * Creates a <code>PipedInputStream</code> so that it is not yet {@linkplain
   * #connect(java.io.PipedOutputStream) connected}. It must be {@linkplain
   * java.io.PipedOutputStream#connect( java.io.PipedInputStream) connected} to a <code>
   * PipedOutputStream</code> before being used.
   */
  ...
  /**
   * Creates a <code>PipedInputStream</code> so that it is not yet {@linkplain
   * #connect(java.io.PipedOutputStream) connected} and uses the specified pipe size for the pipe's
   * buffer. It must be {@linkplain java.io.PipedOutputStream#connect( java.io.PipedInputStream)
   ...
   * is thrown.
   *
   * <p>If <code>src</code> is an unconnected piped output stream and <code>snk</code> is an
   ...
   * @exception IOException If the pipe is <a href=#BROKEN><code>broken</code></a>, {@link
   ...
   *     0} if this input stream has been closed by invoking its {@link #close()} method, or if the
   *     pipe is {@link #connect(java.io.PipedOutputStream) unconnected}, or <a href=#BROKEN><code>
   *     broken</code></a>.
   * @exception IOException if an I/O error occurs.
   * @since JDK1.0.2
   */
